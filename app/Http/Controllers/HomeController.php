...
class HomeController extends Controller
{
    ...
    # the posts of the user being followed by the Auth user
    #### Get all the posts pf the users that the Auth user is following ####
    ...
    public function getSuggestUsers(){
        ...
        $suggested_users = []; //An array --- this will hold the suggested users later on
